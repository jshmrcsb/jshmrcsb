...
- ☀️ QA Officer for **SunTrace**, an AI-assisted solar feasibility and rooftop planning capstone project
- 🏆 Contributor to the **2026 BPI-DOST Innovation Awards** submission
- 📌 Seeking a **QA internship** opportunity to grow in manual testing, defect tracking, and test automation fundamentals
...
*Capstone Project · Quality Assurance Officer · Jan 2026 - Present*

SunTrace is an AI-assisted decision-support system for solar feasibility and rooftop planning, developed by an 8-member capstone team.

### My Role as QA Officer

- Perform manual functional and exploratory testing to uncover bugs and usability issues
- Coordinate with developers to prioritize and resolve defects
- Review frontend UI/UX designs against project requirements and recommend improvements
- Support quality checks across system workflows and user flows
- Apply Selenium for automated UI testing using AI-assisted workflows to generate and refine test scripts
...
Contributor to a team submission for the **2026 BPI-DOST Innovation Awards** through the SunTrace capstone project.
...
- Secure a **QA internship** opportunity
